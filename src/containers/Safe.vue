<template>
    <div class="safe" v-loading="!user_name">
        <div class="safe-infor">
            ...
            <div class="safe-list">
                ...
                <dl v-if="operator_no" flex="cross:center">
                    <dt>账号ID：</dt>
                    <dd>{{operator_no}}</dd>
                </dl>
                <dl flex="cross:center">
        ...
        <div class="safe-setting">
            ...
            <div class="safe-list">
                <dl flex="cross:center">
                    <dt>安全手机：</dt>
                    <dd>
                        <template v-if="operator_mobile_no">{{operator_mobile_no}}</template>
                        <template v-else>未绑定</template>
                    </dd>
                    <dd>
                        <el-button type="text" @click = "bindPhone">
                            <template v-if="operator_mobile_no">修改</template>
        ...
        <el-dialog
            ...
            <div class="dialog-phone">
                <div flex class="flex-wrap"
                    :class="{'new-phone':!operator_mobile_no || newPhoneShow}">
                    <div class="phone-form">
                        <dl flex="main:justify cross:center">
                            <dt flex-box="0">已绑手机号：</dt>
                            <dd flex-box="1">{{operator_mobile_no}}</dd>
                        </dl>
                ...
                $api.put(`/bizeff/merchants/${this.mer_uuid}/operators`,{
                    ...
                    if(res.resp_code == 200){
                        ...
                        _.forEach(res.data,(item,key) => {
                            ...
                            if(key == 'mobile_no' || key == 'email'){
                                this.$store.state[`operator_${key}`] = item;
                            }else{
